...
const{LoginPage}=require('../POM/Loginpage');//./ means access file within folder & ../ means can go outside folder

test('PracticeHomework',async({page})=>
{
   
    //*************************************************************** */
    const username = "akki8794@gmail.com"
    const password="Halliburton@2026"
